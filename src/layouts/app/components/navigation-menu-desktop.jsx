      ...
      <NavigationMenuWrapper>
        <NavigationMenuList>
          ...
          <NavigationMenuItem>
            <NavigationMenuTrigger
              className={cn(
                (pathname.startsWith("/clientesJuridicos") ||
                  pathname.startsWith("/clientesNaturales")) &&
                  "bg-accent text-accent-foreground"
              )}
            >
              Clientes
              ...
              <ul className="grid w-[400px] gap-3 p-4 md:w-[500px] md:grid-cols-2 lg:w-[600px]">
                <NavigationMenuLink asChild>
                  <Link
                    ...
                    to="/clientesJuridicos"
                  >
                    <div className="text-sm font-medium leading-none">
                      Clientes Jurídicos
                    </div>
                    <p className="line-clamp-5 text-sm leading-snug text-muted-foreground">
                      La gestión de clientes jurídicos permite centralizar y
                      organizar la información de cada cliente, facilitando su
                      acceso y actualización en tiempo real. Esta herramienta
                      optimiza la comunicación, el seguimiento de interacciones
                      y el análisis de datos, mejorando la experiencia del
                ...
                <NavigationMenuLink asChild>
                  <Link
                    className="block select-none space-y-1 rounded-md p-3 leading-none no-underline outline-none transition-colors hover:bg-accent hover:text-accent-foreground focus:bg-accent focus:text-accent-foreground"
                    to="/clientesNaturales"
                  >
                    <div className="text-sm font-medium leading-none">
                      Clientes Naturales
                    </div>
                    <p className="line-clamp-5 text-sm leading-snug text-muted-foreground">
                      La gestión de clientes Naturales permite centralizar y
                      organizar la información de cada cliente, facilitando su
                      acceso y actualización en tiempo real. Esta herramienta
                      optimiza la comunicación, el seguimiento de interacciones
                      y el análisis de datos, mejorando la experiencia del
